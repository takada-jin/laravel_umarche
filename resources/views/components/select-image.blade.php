@php
    if($name === 'image1'){ $modal = 'modal1'; }
    if($name === 'image2'){ $modal = 'modal2'; }
    if($name === 'image3'){ $modal = 'modal3'; }
    if($name === 'image4'){ $modal = 'modal4'; }
    if($name === 'image5'){ $modal = 'modal5'; }
@endphp
            ...
            <div class="flex flex-wrap">
                @foreach ($images as $image)
                        <div class="w-1/4 md:p-4 p-2">
                            <div class="border rounded-md p-2 md:p-4 cursor-pointer">
